...
import { UserPlus, User, Lock, ArrowRight, Loader2 } from 'lucide-react';
...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (username.trim() && password.trim() && password === confirmPassword) {
      dispatch(loginStart());
      try {
        const response = await mockAuthApi.register({ username, password });
      ...
      <div className="max-w-md w-full mx-4">
        <div className="backdrop-blur-md bg-white/10 rounded-2xl p-8 border border-cyan-500/20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Join TechnoShop</h2>
